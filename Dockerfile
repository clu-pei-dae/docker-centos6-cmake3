...
ENV  MYSQL_REPO=https://dev.mysql.com/get/mysql80-community-release-el6-3.noarch.rpm \
...
RUN yum -y install @'Development Tools' mysql-community-client mysql-community-devel python-devel boost-devel unzip which\
    && yum clean all
